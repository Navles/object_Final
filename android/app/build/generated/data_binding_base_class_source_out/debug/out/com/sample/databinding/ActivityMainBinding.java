...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final ToggleButton isGpu;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ToggleButton isGpu, @NonNull OverlayView overlay, @NonNull PreviewView viewFinder) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.isGpu;
      ToggleButton isGpu = ViewBindings.findChildViewById(rootView, id);
      if (isGpu == null) {
        break missingId;
      }
